...
const Board: React.FC<BoardProps> = ({ type }) => {
  ...
  return type === "todo" ? (
    <div className="border-2 border-red-400 rounded-2xl bg-white/50 shadow-md relative overflow-x-hidden p-2">
    ...
    <div className="border-2 border-yellow-400 rounded-2xl bg-white/50 shadow-md relative overflow-x-hidden p-2">
    ...
    <div className="border-2 border-green-400 rounded-2xl bg-white/50 shadow-md relative overflow-x-hidden p-2">
